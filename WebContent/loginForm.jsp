  ...
  <body onload="checkIfLoggedIn()">
    ...
    <div id="header">
    	<ul class="navBar">
			...
			<li><a href="profile" class="disabled"><img class="rightNav" src="images/newgraydashboardicon.png"></a>
<!-- 			<div class="links"> -->
<%-- 					<% --%>
// 						if (session.getAttribute("userID") != null) {
<%-- 					%> --%>
<!-- 					<form name="userDashboard" action="profile" method="GET"> -->
<!-- 						<button type="submit" id="dashboard"> -->
<!-- 							<img src="images/newgraydashboardicon.png" class="leftNav"> -->
<!-- 						</button> -->
<!-- 					</form> -->
<%-- 					<% --%>
// 						} else {
<%-- 					%> --%>
<!-- 					<button id="dashboard" onclick="checkForNoUser();" class="leftNav" -->
<!-- 						class="icon"> -->
<!-- 						<img src="images/newgraydashboardicon.png"> -->
<!-- 					</button> -->
<%-- 					<%} %> --%>
<!-- 				</div> -->
				</li>
